...
#Define a function to train the model. In this case, the function returns a Python dictionary to store the training loss for 
#each iteration and accuracy on the validation data.
